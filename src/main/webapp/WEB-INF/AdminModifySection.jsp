                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="modifysection.do" method="post">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>科室号</label>
                                                <input type="text" class="form-control border-input" name="id" placeholder="科室号" value="${ selected.id }">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>科室名</label>
                                                <input type="text" class="form-control border-input" name="name" placeholder="科室名" value="${ selected.name }">
                                            </div>
                                        </div>
                                    </div>
