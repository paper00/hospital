...
<head>
    <meta charset="UTF-8">
    <title>Search Section's Income</title>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                	...
                	<div class="row">
                    	<div class="col-md-8">
                    		<form action="loadincome.do" method="post">
		                    	<div class="form-group" style="margin-left:17px; margin-top:16px;">
		                    		...
		                    		<div class="col-md-3">
					                    <select name="sid" class="form-control border-input">
			                        ...
			                        <c:if test="${ not empty operate_error }">
			                        	<span style="font-size: 17px; color: red;"> ${ operate_error } </span>
			                        </c:if>
		                        </div>
		                    </form>
                    	</div>
                    ...
                    <div class="col-md-12" style="margin-top:30px">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Section's Income</h4>
                            </div>
